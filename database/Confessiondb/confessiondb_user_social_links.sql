...
CREATE TABLE `user_social_links` (
  ...
  CONSTRAINT `user_social_links_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `user_social_links` VALUES (14,20,'Facebook','https://www.facebook.com/horuss.if/'),(15,17,'Facebook','https://www.facebook.com/horuss.if/'),(16,20,'Github','https://github.com/Horus031'),(17,20,'LinkedIn','https://www.linkedin.com/in/v%C3%B5-minh-ngh%C4%A9a-1a00302a2/');
