<main class="mt-24 px-4 w-full md:pl-[26%] md:mt-28 lg:pl-[20%] xl:pl-[20%] 2xl:pl-[16%] transition-all">
    <h1 class="text-2xl font-semibold lg:text-4xl dark:text-gray-400 animate-postSlideIn">Reading History</h1>
    ...
    <div class="relative flex text-3xl text-light dark:text-gray-400 mt-4 animate-postSlideIn">
        ...
        <input type="text" name="historyInput" id="history-search" placeholder="Search reading history" class="border-1 border-secondary rounded-lg pl-12 p-2 flex-1 text-lg font-normal dark:border-gray-700">
    </div>
