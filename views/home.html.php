<main class="bg-white font-poppins flex flex-col overflow-hidden h-fit px-2 mt-24 items-end w-full md:pl-[2%] lg:mt-28 2xl:pl-[10%] 2xl:pr-[2.5%] 3xl:pl-[5%] 4xl:pl-[2%] 4xl:pr-[1%] dark:bg-gray-900">
