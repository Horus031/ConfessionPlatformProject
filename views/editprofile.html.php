            ...
            <div class="mt-2">
                ...
                <div id="social-container" class="mt-2 space-y-4">
                    <div id="facebook-link" class="relative 2xl:w-1/3">
                        ...
                        <input type="url" name="social_links[Facebook]" id="Facebook" class="border-1 border-text rounded-lg p-2 py-3 pl-12 w-full dark:border-gray-700 dark:text-gray-400" placeholder="Your Facebook  Link" value="">
                    </div>
                    ...
                    <div id="github-link" class="relative 2xl:w-1/3">
                        ...
                        <input type="url" name="social_links[Github]" id="Github" class="border-1 border-text rounded-lg p-2 py-3 pl-12 w-full dark:border-gray-700 dark:text-gray-400" placeholder="Your Github  Link" value="">
                    </div>
                    ...
                    <div id="linkedin-link" class="relative 2xl:w-1/3">
                        ...
                        <input type="url" name="social_links[LinkedIn]" id="LinkedIn" class="border-1 border-text rounded-lg p-2 py-3 pl-12 w-full dark:border-gray-700 dark:text-gray-400" placeholder="Your LinkedIn  Link" value="">
                    </div>
